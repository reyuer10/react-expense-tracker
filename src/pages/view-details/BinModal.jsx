    ...
    <div className="flex flex-col">
      ...
      <div className="space-x-3 text-center">
        <button
          ...
          className="px-6 py-2 rounded-xl bg-black text-white hover:bg-slate-700 transition-colors duration-100"
        >
          Yes
        </button>
        <button
          onClick={closeModal}
          className="border-2 px-6 py-2 rounded-xl border-black hover:bg-slate-100 transition-colors duration-100"
        >
          No
        </button>
      </div>

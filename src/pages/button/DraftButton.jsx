...
import draftFill from "../../assets/fill-svg/document.png";

export default function DraftButton({ handleFIllButton, navTop }) {
  return (
    <>
      <Link to="/draft">
        <button
        ...
        >
          {navTop === "/draft" ? (
            <>
              <img src={draftFill} style={{ height: "20px" }} alt="draft" />
            </>
          ) : (
            <>
              <svg
